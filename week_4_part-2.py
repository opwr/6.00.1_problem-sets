...
def playGame(wordList):
    ...
    while True:
        ...
        if reply not in 'nre':
            ...
            # checking the existence of a list (not ideal?)
            try:
                if len(hand) <= 0:
                    raise NameError
                secondinput(hand)
            ...
            return print('this is another error in the main')

    

#    (1) ask for input (n / r / e)
#        if not nre: invalid ... return to (1)
#        if n:
#            deal new hand
#            start (2)
#        if r:
